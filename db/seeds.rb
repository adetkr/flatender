...
puts "Ajout Equipements à l'appartement de pierre"

FlatEquipment.create!(flat_id: pierre_home.id,equipment_id: air.id)
FlatEquipment.create!(flat_id: pierre_home.id,equipment_id: degree.id)
FlatEquipment.create!(flat_id: pierre_home.id,equipment_id: dish.id)
FlatEquipment.create!(flat_id: pierre_home.id,equipment_id: dryer.id)
FlatEquipment.create!(flat_id: pierre_home.id,equipment_id: freezer.id)
FlatEquipment.create!(flat_id: pierre_home.id,equipment_id: refrig.id)
FlatEquipment.create!(flat_id: pierre_home.id,equipment_id: shower.id)
FlatEquipment.create!(flat_id: pierre_home.id,equipment_id: wash.id)

puts "FIn Ajout Equipements à l'appartement de pierre"
